...
proto._opcodeTable = {
  ...
  , 0xb8: [ '_mov_reg_imd' , [ 'mov'  , 'eax' ] ]
  , 0xb9: [ '_mov_reg_imd' , [ 'mov'  , 'ecx' ] ]
  , 0xba: [ '_mov_reg_imd' , [ 'mov'  , 'edx' ] ]
  , 0xbb: [ '_mov_reg_imd' , [ 'mov'  , 'ebx' ] ]
  , 0xbc: [ '_mov_reg_imd' , [ 'mov'  , 'esb' ] ]
  , 0xbd: [ '_mov_reg_imd' , [ 'mov'  , 'ebp' ] ]
  , 0xbe: [ '_mov_reg_imd' , [ 'mov'  , 'esi' ] ]
  , 0xbf: [ '_mov_reg_imd' , [ 'mov'  , 'edi' ] ]
}
...
proto._mov_reg_imd = function _mov_reg_imd(opcode, asm) {
  var regs = this.regs;
  var regName = asm[1]
  var imdSize = 4;
  var imdBytes = this.mem.load(regs.eip, imdSize);
  var imd = leVal(imdBytes, imdSize);
  regs[regName] = imd;
  regs.eip += imdSize;
  debug('imd %s', imd)
}
