...
proto._andi_al = function _andi_al(opcode, asm, dstbytes, srcbytes) {
  this.__logical_opi_al(dstbytes, srcbytes, instruction.and)
}
...
proto._ori_al = function _ori_al(opcode, asm, dstbytes, srcbytes) {
  this.__logical_opi_al(dstbytes, srcbytes, instruction.or)
}
...
proto.__logical_opi_al = function _op_al(dstbytes, srcbytes, op) {
  // 0x0c: `or  al, ..`
  // 0x24: `and al, ..`
  var regs    = this.regs
