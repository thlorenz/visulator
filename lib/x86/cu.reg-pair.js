...
var byOpcode = {
    0xf6: instruction.test
  , 0xf7: instruction.test
}

exports.getInstructionFromRegCode = function getInstructionFromRegCode(regCode, opcode) {
  ...
  return byOpcode[opcode] || instruction.add
}
