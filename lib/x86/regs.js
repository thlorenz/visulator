...
function Registers() {
  ...
  [ 'eax', 'ebx', 'ecx', 'edx' ]
    .forEach(this._defineGeneralPurposeRegister, this);
...
/**
 * General purpose registers are stored as a 4 byte array in order to allow
 ...
 *
 * @name _defineGeneralPurposeRegister
 * @function
 * @param {String} k the name of the register
 */
proto._defineGeneralPurposeRegister = function _defineGeneralPurposeRegister(k) {
  var field    = '_' + k;
  var lowWord  = k[1] + 'x';  // ax
  var lowByte  = k[1] + 'l';  // al
  var highByte = k[1] + 'h';  // ah
