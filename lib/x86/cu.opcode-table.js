...
module.exports = {
  ...
  , 0x08: [ '_orr'             , [ 'or'       , 'r8 - r8' ]         , BYTE  , BYTE                   ]
  , 0x09: [ '_orr'             , [ 'or'       , 'r16/32 - r16/32' ] , DWORD , DWORD                   ]
  ...
  , 0x34: [ '_xori_al'         , [ 'xor al'   , 'r8'              ] , BYTE  , BYTE                    ]
  ...
  , 0x80: [ '_logical_opi_wdw' , [ 'r/8'      , 'i/8'            ]  , BYTE  , BYTE                      , true ]
  , 0x81: [ '_logical_opi_wdw' , [ 'r/32'     , 'i/32'            ] , DWORD , DWORD                     , true ]
  , 0x83: [ '_logical_opi_wdw' , [ 'r/32/16'  , 'i/8'             ] , DWORD , BYTE                      , true ]
